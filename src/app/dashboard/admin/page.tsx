    ...
    >
      ...
      <div className="rounded-xl border border-white/10 bg-atria-graphite p-4 shadow-card">
        ...
        <ActionList
          variant="step"
          items={[
            "Revisar ingresos y gastos pendientes antes del cierre.",
            "Enviar solicitudes de ajuste cuando haya novedades de propietarios.",
            "Publicar el cierre solo después de la revisión contable.",
          ]}
        />
      </div>
